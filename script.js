document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      const errorType = validateField(field);
      if (errorType) {
    ...
    // Live validation on input (clear errors while typing)
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '57ab3aaa-0787-4071-9b34-5267143a3521',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '57ab3aaa-0787-4071-9b34-5267143a3521';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57ab3aaa-0787-4071-9b34-5267143a3521';
